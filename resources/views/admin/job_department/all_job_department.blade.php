...
<html lang="en">
  ...
  <head>
    ...
    <title> Manage Job Deparment</title>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Manager Job Deparment</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item">Dashboard</li>
                  <li class="breadcrumb-item active" aria-current="page">Manage Job Deparment</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
                ...
                @endif
                    ...
                    <table class="table table-hover">
                        ...
                        <tr data-id="{{$row->department_id}}">
                            ...
                            <td colspan="2">
                              <button class="EditRecord btn btn-primary" data-id="{{$row->department_id}}" data-name="{{$row->department_name}}">Edit</button>
                              <button class="deleteRecord btn btn-danger" data-id="{{$row->department_id}}" value="{{$row->department_name}}">Delete</button>
                            </td>
                        </tr>
                        @endforeach
                    </table>
                  ...
                  <form action="{{ url('/InsertCourse') }}" method="post" id="AddUserForm">
                      ...
                      <div class="modal-body">
                              <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="{{ old('course_name') }}" required />
                      ...
                      <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                          <button type="submit" class="btn btn-danger">Yes, Add Department</button>
                      </div>
                  </form>
              </div>
          </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="" method="post" id="EditUserForm">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-danger">Yes, Update Department</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.deleteRecord').click(function (e) {
                ...
                $('#deleteUserForm').attr('action', '/delete_job_Department/' + user_id);
            ...
            $('.AddRecord').click(function (e) {
                ...
                $('#AddUserForm').attr('action', '/InsertJobDepartment/');
            ...
            $('.EditRecord').click(function (e) {
                ...
                // Set the course ID and name in the modal
                $('#category_id').val(courseId);  // Set course ID as a hidden field
                $('#category_name').val(courseName);   // Set course name to the input field
                
                // Set the action URL for the form
                $('#EditUserForm').attr('action', '/EditJobDepartment/' + courseId);
