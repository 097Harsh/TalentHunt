                ...
                @endif
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>{{$record->established_date}}</td>
                        </tr>
                        <tr>
                            <td>Number Of Employee</td>
                            <td>{{$record->num_of_emp}}</td>
                        </tr>
                        <tr>
                            <td>Webiste URL</td>
                        ...
                        <tr>
                            <td colspan="2">
                                <a href="{{route('EditCompanyProfile')}}"><button class="btn btn-primary" style="float: right;">Update Profile</button></a>
                            </td>
                        </tr>
                    </table>
                </div>
