...
<html lang="en">
  ...
  <head>
    ...
    <title> Manage Job Category</title>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Manager Job Category</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item">Dashboard</li>
                  <li class="breadcrumb-item active" aria-current="page">Manage Job Category</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
                ...
                @endif
                    ...
                    <table class="table table-hover">
                        ...
                        <tr data-id="{{$row->category_id}}">
                            ...
                            <td colspan="2">
                              <button class="EditRecord btn btn-primary" data-id="{{$row->category_id}}" data-name="{{$row->category_name}}">Edit</button>
                              <button class="deleteRecord btn btn-danger" data-id="{{$row->category_id}}" value="{{$row->category_name}}">Delete</button>
                            </td>
                        </tr>
                        @endforeach
                    </table>
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  <form action="{{ url('/InsertCourse') }}" method="post" id="AddUserForm">
                      ...
                      <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                          <button type="submit" class="btn btn-danger">Yes, Add Category</button>
                      </div>
                  </form>
              </div>
          </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="" method="post" id="EditUserForm">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-danger">Yes, Update Category</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.deleteRecord').click(function (e) {
                ...
                $('#deleteUserForm').attr('action', '/delete_job_category/' + user_id);
            ...
            $('.AddRecord').click(function (e) {
                ...
                $('#AddUserForm').attr('action', '/InsertJobCategory/');
            ...
            $('.EditRecord').click(function (e) {
                ...
                $('#EditUserForm').attr('action', '/EditJobCategory/' + courseId);
