      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Manage Course</h3></div>
              <div class="col-sm-6">
            ...
            <div class="row">
                ...
                @endif
                    ...
                    <table class="table table-hover">
                        ...
                        <tr data-id="{{$course->course_id}}">
                            ...
                            <td>{{$course->email}}</td>
                            <td colspan="2">
                              <button class="EditRecord btn btn-primary" data-id="{{$course->course_id}}" data-name="{{$course->course_name}}">Edit</button>
              ...
              <nav aria-label="..." style="float:right;">
                  <ul class="pagination" style="float:right;">
                    ...
                    @else
                      <li class="page-item">
                          <a class="page-link" href="{{ $courses->previousPageUrl() }}" tabindex="-1" aria-disabled="true">Previous</a>
                      </li>
                    @endif
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.AddRecord').click(function (e) {
                ...
                $('#AddUserForm').attr('action', '/InsertCourse/');
            ...
            // Show the Edit modal when clicking the Edit button
                $('.EditRecord').click(function (e) {
                      ...
                      $('#edit_course_id').val(courseId);  // Set course ID as a hidden field
                      $('#course_name').val(courseName);   // Set course name to the input field
                      
                      // Set the action URL for the form
                      $('#EditUserForm').attr('action', '/UpdateCourse/' + courseId);
