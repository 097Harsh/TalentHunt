              ...
              <div class="col-lg-12">
                    ...
                    <form action="{{route('updateUser',['id' => $user->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row mb-3">
                            <label for="email" class="col-sm-2 col-form-label">Objetive</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="objective" name="objective" value="{{$user->objective}}" />
                          ...
                          <div class="row mb-3">
                            <label for="email" class="col-sm-2 col-form-label">Designation</label>
                            <div class="col-sm-10">
                          ...
                          <div class="row mb-3">
                            <label for="email" class="col-sm-2 col-form-label">upload resume</label>
                            <div class="col-sm-10">
                          ...
                          <div class="row mb-3">
                            <label for="email" class="col-sm-2 col-form-label">choose course</label>
                            <div class="col-sm-10">
                                <select class="form-control selectpicker" name="courses[]" id="courses" multiple>
                                    <option value="" disabled selected>-----Select Course-----</option>
                                    @foreach($courses as $course)
                                        <option value="{{ $course->course_name }}" 
                                                @if(in_array($course->course_name, explode(',', $user->course))) selected @endif>
                                            {{ $course->course_name }}
                                        </option>
                                    @endforeach
                                </select>
                          ...
                          <div class="row mb-3">
                            <label for="email" class="col-sm-2 col-form-label">choose skills</label>
                            <div class="col-sm-10">
                                <select class="form-control selectpicker" name="skill_id[]" id="skill_id" multiple required>
                                      ...
                                      @foreach($skills as $skill)
                                          <option value="{{ $skill->skill_name }}" 
                                                  @if(in_array($skill->skill_name, explode(',', $user->skills))) selected @endif>
                                              {{ $skill->skill_name }}
                                          </option>
                                      @endforeach
                                  </select>
